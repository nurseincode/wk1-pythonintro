...
# <, >, <=, >=, == 
# print(5 == 5) # Equality Operator: The value on the left equals to the one on the right? Returns a Boolean True/False
...
# --> not operator:  -> Turns True into False and vice versa
...
# print(num1 + num2)
# print(num1)
# print(num2) # Non-destructive operations
...
name = "Wangari"
race = "Black"
print('My name is ' + name + ' and I live in Melbourne')

# f-string (formatted string)
print(f'My name is {name}, I am {race} and I live in Melbourne')
